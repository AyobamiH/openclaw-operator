...
REPAIR_PROOF_DOC="$REPO_ROOT/docs/operations/runtime-repair-proof-chain-2026-09-14.md"
...
require_contains "$DOCS_INDEX" "runtime-repair-proof-chain-2026-09-14.md"
require_contains "$DOCS_NAV" "runtime-repair-proof-chain-2026-09-14.md"
require_contains "$REPAIR_PROOF_DOC" "Posting health"
require_contains "$REPAIR_PROOF_DOC" "Failed / separate open blockers"
require_contains "$REPAIR_PROOF_DOC" "must not cite"
require_contains "$REPAIR_PROOF_DOC" "providerWrites=0"
require_contains "$REPAIR_PROOF_DOC" "91ee842"
