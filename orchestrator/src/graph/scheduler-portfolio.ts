...
const FACTORY_RUNTIME_V1 = "/home/oneclickwebsitedesignfactory/.openclaw/runtime/deterministic-self-identification-publishing-engine/11a8067b299505e7a942791b0d902b1fa16a871b";
const FACTORY_RUNTIME_V2 = "/home/oneclickwebsitedesignfactory/.openclaw/runtime/deterministic-self-identification-publishing-engine/20260808-full-pregraph-v2";
const FACTORY_RUNTIME_V3 = "/home/oneclickwebsitedesignfactory/.openclaw/runtime/deterministic-self-identification-publishing-engine/20260808-full-pregraph-v3";
const definitions = {
...
const portfolio = [
  ...
  entry({ migrationId: "campaign-content-factory-shadow-v1", scheduleId: "6fd37958-b450-400e-8c06-a781670f3a03", declarationKey: "deterministic-self-identification-shadow-v1", graphIdentity: "governed-task-execution@1.0.0", namespace: "production.campaign-factory.shadow", provider: "local", accountId: "campaign-factory", cronExpression: "0 5,7,11,15,17 * * *", authority: "local_persistent", input: { lane: "campaign-factory", taskType: "campaign-content-factory", agentId: "content-agent", ingressId: "$slotId", shadowMode: false, payload: { registryPath: `${FACTORY_RUNTIME_V1}/config/publishing/registry.v1.json`, integrationPath: `${FACTORY_RUNTIME_V1}/config/publishing/production-integration.v1.json`, databasePath: "/home/oneclickwebsitedesignfactory/.openclaw/state/openclaw-operator/database/deterministic-publishing.sqlite", artifactRoot: `${WORKSPACE}/artifacts/business-value/marketing`, rendererEntrypoint: `${FACTORY_RUNTIME_V1}/renderer/bin/local-media-renderer.mjs`, opportunityId: "auto", observedAt: "$scheduledAt", nodeExecutable: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/node", openclawBin: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/openclaw", workspace: WORKSPACE } } }),
  entry({ migrationId: "campaign-content-factory-full-pregraph-v2", scheduleId: "4e85ad8c-b253-40d6-adad-4c8cde39ad67", declarationKey: "deterministic-self-identification-full-pregraph-v2", graphIdentity: "governed-task-execution@1.0.0", namespace: "production.campaign-factory.full-pregraph", provider: "local", accountId: "campaign-factory", cronExpression: "0 5,7,11,15,17 * * *", authority: "local_persistent", input: { lane: "campaign-factory", taskType: "campaign-content-factory", agentId: "content-agent", ingressId: "$slotId", shadowMode: false, payload: { registryPath: `${FACTORY_RUNTIME_V2}/config/publishing/registry.v1.json`, integrationPath: `${FACTORY_RUNTIME_V2}/config/publishing/production-integration.v1.json`, databasePath: "/home/oneclickwebsitedesignfactory/.openclaw/state/openclaw-operator/database/deterministic-publishing.sqlite", artifactRoot: `${WORKSPACE}/artifacts/business-value/marketing`, rendererEntrypoint: `${FACTORY_RUNTIME_V2}/renderer/bin/local-media-renderer.mjs`, opportunityId: "auto", observedAt: "$scheduledAt", nodeExecutable: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/node", openclawBin: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/openclaw", workspace: WORKSPACE } } }),
  entry({ migrationId: "campaign-content-factory-full-pregraph-v3", scheduleId: "cb58654b-9136-4f75-8b4f-c7431c7fd3de", declarationKey: "deterministic-self-identification-full-pregraph-v3", graphIdentity: "governed-task-execution@1.0.0", namespace: "production.campaign-factory.full-pregraph", provider: "local", accountId: "campaign-factory", cronExpression: "0 5,7,11,15,17 * * *", authority: "local_persistent", input: { lane: "campaign-factory", taskType: "campaign-content-factory", agentId: "content-agent", ingressId: "$slotId", shadowMode: false, payload: { registryPath: `${FACTORY_RUNTIME_V2}/config/publishing/registry.v1.json`, integrationPath: `${FACTORY_RUNTIME_V2}/config/publishing/production-integration.v1.json`, databasePath: "/home/oneclickwebsitedesignfactory/.openclaw/state/openclaw-operator/database/deterministic-publishing.sqlite", artifactRoot: `${WORKSPACE}/artifacts/business-value/marketing`, rendererEntrypoint: `${FACTORY_RUNTIME_V2}/renderer/bin/local-media-renderer.mjs`, opportunityId: "auto", observedAt: "$scheduledAt", nodeExecutable: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/node", openclawBin: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/openclaw", workspace: WORKSPACE } } }),
  entry({ migrationId: "campaign-content-factory-full-pregraph-v4", scheduleId: "2df05813-93e1-4d3f-8731-a5c2de3625d5", declarationKey: "deterministic-self-identification-full-pregraph-v4", graphIdentity: "governed-task-execution@1.0.0", namespace: "production.campaign-factory.full-pregraph", provider: "local", accountId: "campaign-factory", cronExpression: "0 5,7,11,15,17 * * *", authority: "local_persistent", graphJobEnabled: true, commandNoOutputTimeoutSeconds: 1_800, input: { lane: "campaign-factory", taskType: "campaign-content-factory", agentId: "content-agent", ingressId: "$slotId", shadowMode: false, payload: { registryPath: `${FACTORY_RUNTIME_V3}/config/publishing/registry.v1.json`, integrationPath: `${FACTORY_RUNTIME_V3}/config/publishing/production-integration.v1.json`, databasePath: "/home/oneclickwebsitedesignfactory/.openclaw/state/openclaw-operator/database/deterministic-publishing.sqlite", artifactRoot: `${WORKSPACE}/artifacts/business-value/marketing`, rendererEntrypoint: `${FACTORY_RUNTIME_V3}/renderer/bin/local-media-renderer.mjs`, opportunityId: "auto", observedAt: "$scheduledAt", nodeExecutable: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/node", openclawBin: "/home/oneclickwebsitedesignfactory/.nvm/versions/node/v24.18.0/bin/openclaw", workspace: WORKSPACE } } }),
